...
const tools = [
  {
    name: 'Encore',
    description: 'Web to app platform metrics and dashboard',
    icon: DevicePhoneMobileIcon,
    href: 'https://walrus-app-yg2sd.ondigitalocean.app/api/apps/2faac80d-a151-4ca3-a1e5-1ae908fdcf4e/metrics/dashboard',
    color: 'bg-blue-500',
    available: true,
  },
  {
    name: 'Data Dashboard',
    description: 'Comprehensive metrics and analytics platform',
    icon: ChartPieIcon,
    href: 'https://data-dash-bice.vercel.app/',
    color: 'bg-green-500',
    available: true,
  },
  {
    name: 'Support Board',
    description: 'Kanban board for support inquiries by app',
    icon: TicketIcon,
